    ...
    laws: [
      {
        ...
        a: '台中、新竹、桃園、新北 這幾個縣市要求桌遊空間需有 D1 類組使用執照，若場地原執照不符，需向主管機關申請變更。彰化以南目前沒有此要求。我們會先幫你評估場地可變更性，避免白花錢。'
      },
      {
        icon: '🎲',
        q: '自助桌遊會不會被當成賭博場所？',
    ...
    commonFaqs: [
      {
        icon: '🙋',
        q: '加盟需要具備相關經驗嗎？',
        a: '不需要。我們提供從找點、法規評估、裝修規劃、設備配置、系統教學到開幕營運的一條龍輔導。即使沒有餐飲或零售經驗，也能順利上線。'
      },
      {
        icon: '🏠',
        q: '需要自己找店面嗎？',
        a: '你可以自行找點，也可以由我們協助提供商圈建議與基本條件方向。確定店址前，我們會協助進行商圈潛力評估、使用分區與法規可行性初判，降低投資風險。'
      },
      {
        icon: '🗺️',
        q: '加盟後會有區域保障嗎？',
        a: '目前採「無區域保障、無距離限制」加盟模式。據點評估以商圈成熟度、坪效、人口結構與營運可行性為主要依據，確保每一家門市都具備實際經營條件。'
      },
      {
        icon: '🕐',
        q: '無人自助真的能穩定營運嗎？',
        a: '可以。我們使用線上繳費、門禁管理、遠端監控，大量節省人事成本，已驗證為可長期穩定營運的商業模式。目前全台近 100 家店、存活率 97%、0 虧損門店。'
      },
      {
        icon: '🎓',
        q: '開店後如果不會經營，總部會怎麼協助？',
        a: '我們提供系統操作教學、營運 SOP、客訴處理流程、行銷活動建議、遠端技術支援。24 小時客服隨時處理問題，讓你能專注營收，不必煩惱技術面。'
      },
      {
        icon: '🧰',
        q: '可以使用自己的工班嗎？',
        a: '主要設備安裝必須使用公司指定的合作廠商，包含麻將桌、水電配線、隔間、冷氣、包廂門及智能門鎖等。這是為了確保施工品質與系統整合穩定性，避免後續維護產生問題。少數非核心項目可以選用自己的工班。'
      },
      {
        icon: '💰',
        q: '繳費機找 50 元跟找 100 元有什麼差異？',
        a: '標準是 50 元硬幣找零機，客人投入的 50 元也會循環找零，生意好的話大約一週補一次零錢。升級百鈔找零機後，百元鈔也會自動循環找零，大多店家一個月收一次錢就夠，管理更輕鬆。建議預算許可直接升級。'
      },
      {
        icon: '🔄',
        q: '店家可以轉移場地嗎？',
        a: '可以。我們提供現場丈量、場地繪圖、工班施工聯絡、控電箱重做等服務。場地轉移或同址擴大會收工本費，不含搬運費及裝修材料費。'
      },
      {
        icon: '🏪',
        q: '想開分店怎麼辦？',
        a: '歡迎！針對想開分店的業者，我們提供場地開發協助與分店加盟流程，直營店家也有優惠條件。有擴展計畫歡迎在表單備註欄告訴我們。'
      },
    ],
