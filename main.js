  ...
  return {
    ...
    commonFaqs: [
      ...
      },
      {
        icon: '💸',
        q: '總投資要多少？會不會有隱藏費用？',
        a: '完整投資約 <span class="text-accent-600 font-bold">150-280 萬</span>，依坪數與格局而定：系統建置費 30 萬（買斷）、裝潢施工 80-150 萬、麻將桌/家具 50-80 萬、押金與雜支 20-30 萬。月度固定支出約 <span class="text-accent-600 font-bold">6-13.5 萬</span>（租金+水電+系統月費 8,000+清潔）。<span class="text-accent-600 font-bold">所有費用在合約中公開透明</span>，不會有「開業後才知道」的隱藏項目。'
      },
      {
        icon: '🎲',
        q: '自助桌遊會不會被當成賭博？法律上安全嗎？',
        a: '這是最多創業者私下擔心的問題。我們的系統設計與店規從一開始就以<span class="text-accent-600 font-bold">「純娛樂」為前提做法律切割</span>：無現金賭注、無抽頭機制、消費記錄透明。總部會提供<span class="text-accent-600 font-bold">純娛樂經營 SOP 與店規範本</span>，全台近 100 家店實戰驗證過的合規設計，降低你跟賭博罪扯上關係的風險。'
      },
      {
        icon: '🎓',
        q: '開店後如果不會經營，總部會怎麼協助？',
      ...
      },
      {
        icon: '🛡️',
        q: '萬一生意不好，總部會怎麼幫？',
        a: '這是我們最重視的事。除了 24H 技術支援，我們會依你店況提供<span class="text-accent-600 font-bold">營運診斷、行銷活動、定價策略</span>的客製化改善方案。為什麼敢講？因為<span class="text-accent-600 font-bold">整體存活率 97%、目前無虧損門店</span>。總部的價值不只在開店，更在開店後持續陪你優化。'
      },
      {
        icon: '🧰',
        q: '可以使用自己的工班嗎？',
